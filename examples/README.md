...
Versioned task definitions and Claude Code skills meant to be shared across projects. These are examples / source of truth to copy; the daemon does not read this directory.
...
```bash
cp -R examples/tasks/squash-merge ~/workspace/queohoh/global/tasks/
```
